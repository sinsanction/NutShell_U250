...
################################################################
# This is a generated script based on design: bd_bc56
#
...
connect_bd_intf_net -intf_net Conn1 [get_bd_intf_ports SLOT_1_AXI] [get_bd_intf_pins g_inst/slot_1_axi]
  ...
  connect_bd_net -net net_slot_0_axi_ar_ctrl [get_bd_pins ila_lib/probe36] [get_bd_pins slot_0_ar/dout]
  ...
  connect_bd_net -net net_slot_0_axi_aw_ctrl [get_bd_pins ila_lib/probe33] [get_bd_pins slot_0_aw/dout]
  ...
  connect_bd_net -net net_slot_0_axi_b_ctrl [get_bd_pins ila_lib/probe35] [get_bd_pins slot_0_b/dout]
  ...
  connect_bd_net -net net_slot_0_axi_r_ctrl [get_bd_pins ila_lib/probe37] [get_bd_pins slot_0_r/dout]
  ...
  connect_bd_net -net net_slot_0_axi_w_ctrl [get_bd_pins ila_lib/probe34] [get_bd_pins slot_0_w/dout]
  ...
  connect_bd_net -net net_slot_1_axi_ar_cnt [get_bd_pins g_inst/m_slot_1_axi_ar_cnt] [get_bd_pins ila_lib/probe38]
  connect_bd_net -net net_slot_1_axi_ar_ctrl [get_bd_pins ila_lib/probe74] [get_bd_pins slot_1_ar/dout]
  connect_bd_net -net net_slot_1_axi_araddr [get_bd_pins g_inst/m_slot_1_axi_araddr] [get_bd_pins ila_lib/probe39]
  connect_bd_net -net net_slot_1_axi_arburst [get_bd_pins g_inst/m_slot_1_axi_arburst] [get_bd_pins ila_lib/probe40]
  connect_bd_net -net net_slot_1_axi_arcache [get_bd_pins g_inst/m_slot_1_axi_arcache] [get_bd_pins ila_lib/probe41]
  connect_bd_net -net net_slot_1_axi_arid [get_bd_pins g_inst/m_slot_1_axi_arid] [get_bd_pins ila_lib/probe42]
  connect_bd_net -net net_slot_1_axi_arlen [get_bd_pins g_inst/m_slot_1_axi_arlen] [get_bd_pins ila_lib/probe43]
  connect_bd_net -net net_slot_1_axi_arlock [get_bd_pins g_inst/m_slot_1_axi_arlock] [get_bd_pins ila_lib/probe44]
  connect_bd_net -net net_slot_1_axi_arprot [get_bd_pins g_inst/m_slot_1_axi_arprot] [get_bd_pins ila_lib/probe45]
  connect_bd_net -net net_slot_1_axi_arqos [get_bd_pins g_inst/m_slot_1_axi_arqos] [get_bd_pins ila_lib/probe46]
  connect_bd_net -net net_slot_1_axi_arready [get_bd_pins g_inst/m_slot_1_axi_arready] [get_bd_pins slot_1_ar/In1]
  connect_bd_net -net net_slot_1_axi_arsize [get_bd_pins g_inst/m_slot_1_axi_arsize] [get_bd_pins ila_lib/probe47]
  connect_bd_net -net net_slot_1_axi_aruser [get_bd_pins g_inst/m_slot_1_axi_aruser] [get_bd_pins ila_lib/probe48]
  connect_bd_net -net net_slot_1_axi_arvalid [get_bd_pins g_inst/m_slot_1_axi_arvalid] [get_bd_pins slot_1_ar/In0]
  connect_bd_net -net net_slot_1_axi_aw_cnt [get_bd_pins g_inst/m_slot_1_axi_aw_cnt] [get_bd_pins ila_lib/probe49]
  connect_bd_net -net net_slot_1_axi_aw_ctrl [get_bd_pins ila_lib/probe71] [get_bd_pins slot_1_aw/dout]
  connect_bd_net -net net_slot_1_axi_awaddr [get_bd_pins g_inst/m_slot_1_axi_awaddr] [get_bd_pins ila_lib/probe50]
  connect_bd_net -net net_slot_1_axi_awburst [get_bd_pins g_inst/m_slot_1_axi_awburst] [get_bd_pins ila_lib/probe51]
  connect_bd_net -net net_slot_1_axi_awcache [get_bd_pins g_inst/m_slot_1_axi_awcache] [get_bd_pins ila_lib/probe52]
  connect_bd_net -net net_slot_1_axi_awid [get_bd_pins g_inst/m_slot_1_axi_awid] [get_bd_pins ila_lib/probe53]
  connect_bd_net -net net_slot_1_axi_awlen [get_bd_pins g_inst/m_slot_1_axi_awlen] [get_bd_pins ila_lib/probe54]
  connect_bd_net -net net_slot_1_axi_awlock [get_bd_pins g_inst/m_slot_1_axi_awlock] [get_bd_pins ila_lib/probe55]
  connect_bd_net -net net_slot_1_axi_awprot [get_bd_pins g_inst/m_slot_1_axi_awprot] [get_bd_pins ila_lib/probe56]
  connect_bd_net -net net_slot_1_axi_awqos [get_bd_pins g_inst/m_slot_1_axi_awqos] [get_bd_pins ila_lib/probe57]
  connect_bd_net -net net_slot_1_axi_awready [get_bd_pins g_inst/m_slot_1_axi_awready] [get_bd_pins slot_1_aw/In1]
  connect_bd_net -net net_slot_1_axi_awsize [get_bd_pins g_inst/m_slot_1_axi_awsize] [get_bd_pins ila_lib/probe58]
  connect_bd_net -net net_slot_1_axi_awuser [get_bd_pins g_inst/m_slot_1_axi_awuser] [get_bd_pins ila_lib/probe59]
  connect_bd_net -net net_slot_1_axi_awvalid [get_bd_pins g_inst/m_slot_1_axi_awvalid] [get_bd_pins slot_1_aw/In0]
  connect_bd_net -net net_slot_1_axi_b_cnt [get_bd_pins g_inst/m_slot_1_axi_b_cnt] [get_bd_pins ila_lib/probe60]
  connect_bd_net -net net_slot_1_axi_b_ctrl [get_bd_pins ila_lib/probe73] [get_bd_pins slot_1_b/dout]
  connect_bd_net -net net_slot_1_axi_bid [get_bd_pins g_inst/m_slot_1_axi_bid] [get_bd_pins ila_lib/probe61]
  connect_bd_net -net net_slot_1_axi_bready [get_bd_pins g_inst/m_slot_1_axi_bready] [get_bd_pins slot_1_b/In1]
  connect_bd_net -net net_slot_1_axi_bresp [get_bd_pins g_inst/m_slot_1_axi_bresp] [get_bd_pins ila_lib/probe62]
  connect_bd_net -net net_slot_1_axi_buser [get_bd_pins g_inst/m_slot_1_axi_buser] [get_bd_pins ila_lib/probe63]
  connect_bd_net -net net_slot_1_axi_bvalid [get_bd_pins g_inst/m_slot_1_axi_bvalid] [get_bd_pins slot_1_b/In0]
  connect_bd_net -net net_slot_1_axi_r_cnt [get_bd_pins g_inst/m_slot_1_axi_r_cnt] [get_bd_pins ila_lib/probe64]
  connect_bd_net -net net_slot_1_axi_r_ctrl [get_bd_pins ila_lib/probe75] [get_bd_pins slot_1_r/dout]
  connect_bd_net -net net_slot_1_axi_rdata [get_bd_pins g_inst/m_slot_1_axi_rdata] [get_bd_pins ila_lib/probe65]
  connect_bd_net -net net_slot_1_axi_rid [get_bd_pins g_inst/m_slot_1_axi_rid] [get_bd_pins ila_lib/probe66]
  ...
  connect_bd_net -net net_slot_1_axi_rresp [get_bd_pins g_inst/m_slot_1_axi_rresp] [get_bd_pins ila_lib/probe67]
  connect_bd_net -net net_slot_1_axi_ruser [get_bd_pins g_inst/m_slot_1_axi_ruser] [get_bd_pins ila_lib/probe68]
  connect_bd_net -net net_slot_1_axi_rvalid [get_bd_pins g_inst/m_slot_1_axi_rvalid] [get_bd_pins slot_1_r/In0]
  connect_bd_net -net net_slot_1_axi_w_ctrl [get_bd_pins ila_lib/probe72] [get_bd_pins slot_1_w/dout]
  connect_bd_net -net net_slot_1_axi_wdata [get_bd_pins g_inst/m_slot_1_axi_wdata] [get_bd_pins ila_lib/probe69]
  ...
  connect_bd_net -net net_slot_1_axi_wstrb [get_bd_pins g_inst/m_slot_1_axi_wstrb] [get_bd_pins ila_lib/probe70]
